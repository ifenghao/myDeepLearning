...
shape = (f1, fin, 3, 3)
w11 = initial.weightInitCNN3(shape, 'w1')
w12 = initial.weightInitColfc((shape[0], expand, shape[1]), 'w2')
b11 = initial.biasInit(shape[:2], 'b1')
b12 = initial.biasInit((shape[0], expand), 'b2')
params.append([w11, w12, b11, b12])
shape = (f2, f1 * expand, 3, 3)
w21 = initial.weightInitCNN3(shape, 'w1')
w22 = initial.weightInitColfc((shape[0], expand, shape[1]), 'w2')
b21 = initial.biasInit(shape[:2], 'b1')
b22 = initial.biasInit((shape[0], expand), 'b2')
params.append([w21, w22, b21, b22])
shape = (f3, f2 * expand, 3, 3)
w31 = initial.weightInitCNN3(shape, 'w1')
w32 = initial.weightInitColfc((shape[0], expand, shape[1]), 'w2')
b31 = initial.biasInit(shape[:2], 'b1')
b32 = initial.biasInit((shape[0], expand), 'b2')
